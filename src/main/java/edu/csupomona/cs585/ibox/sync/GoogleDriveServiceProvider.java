...
public class GoogleDriveServiceProvider {
	...
	private static String CLIENT_ID = "526261389610-dap4il8349b90u5vac1ca9ejqt3gdbtn.apps.googleusercontent.com" ;//"PASTE_YOUR_CLIENT_ID_HERE"
	private static String CLIENT_SECRET = "W1Kg3_5wGXAAFVxZl3Sn-bCs";//"PASTE_YOUR_CLIENT_SECRET_HERE"
	...
	public void initGoogleDriveServices() throws IOException {
		...
		googleDriveClient = new Drive.Builder(httpTransport, jsonFactory, credential).setApplicationName("iboxLocal").build();
	}
